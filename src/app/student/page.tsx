...
import type { CapabilityView } from './StudentDashboardCharts';
import LoadingSpinner from '@/components/common/LoadingSpinner';

const StudentDashboardCharts = dynamic(() => import('./StudentDashboardCharts'), { ssr: false, loading: () => <ChartSkeleton height={240} /> });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* ===== 차트 영역 ===== */}
        <StudentDashboardCharts scoreTrendData={scoreTrendData} capabilityView={capabilityView} />
