...
import type { MathCapabilityView, ScoreTrendItem } from './GrowthChartSection';
...
const GrowthChartSection = dynamic(() => import('./GrowthChartSection'), { ssr: false, loading: () => <ChartSkeleton height={300} /> });
