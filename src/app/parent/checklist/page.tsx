      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <div className="flex gap-3">
            <Link
              href="/parent"
              className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-white border border-gray-200 rounded-xl text-gray-600 text-sm font-medium hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
            >
            ...
            <Link
              href="/parent/reports"
              className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-indigo-600 rounded-xl text-white text-sm font-medium hover:bg-indigo-700 transition-all duration-200"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
